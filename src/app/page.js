		...
		<>
			...
			<section className="h-screen section">
				...
				>
					...
					>
						<div className="max-w-md flex flex-col justify-center items-center font-playfair tracking-widest shadow-lg rounded-large shadow-cyan-900 text-white backdrop-brightness-75 mt-10 md:mt-0">
